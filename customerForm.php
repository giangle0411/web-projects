...
if ($_REQUEST['btn_Option'] == "1.00")
{
    $Option = "1.00";

}
else if ($_REQUEST['btn_Option']=="3.00")
{
$Option = 3.00;
}
else if ($_REQUEST['btn_Option'] == "5.00")
{
$Option = 5.00;
}
else if ($_REQUEST['btn_Option']=="7.00")
{
   $Option = 7.00; 
}
                            ...
                            <div class="col-20 col-lg-6">
                                <div class="contact-content">
                                    ...
                                    <div class="contact-form-area">
                                        <form action="https://titan.csit.rmit.edu.au/~s3657271/EB2/receiptpage.php" method="POST">
                                            <div class="row"> 
                                               ...
                                               <h4>Customer Details</h4>
                                                ...
                                                <div class="col-12 col-lg-7">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="ApartNum"  placeholder="Apartment Number (Optional)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-5">
                                                  ...
                                                  <div class="col-12 col-lg-8">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" name="CCNum"  placeholder="Credit Card Number">
                                                    </div>
                                                </div>
                                                   ...
                                                   <div class="col-12 col-lg-4">
                                                    <div class="form-group">
                                                      <label>Expiry Date</label>  <input type="Date" class="form-control" name="CCV"  placeholder="Expiry Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <!-- <a href="receiptpage.php" ><button type="submit" class="btn foode-btn">Submit</button></a> -->
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="contact-content contact-information">                                   
                                 ...
                                 <div class="single-contact-info d-flex">
                                  ...
                                  <h4>Price Summary :  <? php echo $Option  ?> </h4>
